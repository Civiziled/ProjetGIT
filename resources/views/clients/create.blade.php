    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-2">Créer un nouveau client</p>
            </div>
    ...
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('clients.store') }}" class="space-y-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="address" 
                                  ...
                                  placeholder="Adresse complète (optionnel)">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('clients.index') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400 transition duration-300">
                    Annuler
                </a>
